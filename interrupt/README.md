# Interrupt Example   
On the CC2500, GDO0, GDO1, and GDO2 can be used as interrupt output signals.   
GDO1 is shared with the SO pin in the SPI interface.   
This library provides the GDO2 interrupt.   
The CC2500 supports the following interrupts.   
...
# Configuration   
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/104d9342-7e86-4b96-b127-9ab03faf9d97" />
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/4ca23ceb-4626-44b3-8f91-ff95ed9673f0" />

# Wiring
Add a wire to GDO2.   
|CC2500||ESP32|ESP32-S2/S3|ESP32-Cx/Hx|
|:-:|:-:|:-:|:-:|:-:|
