# BLE Example   
This is cc2500 and BLE gateway application.   
...
```
            +------------+          +------------+          +------------+
            |            |          |            |          |            |
            | Smartphone |--(BLE)-->|   ESP32    |--(SPI)-->|   cc2500   |==(Radio)==>
            |            |          |            |          |            |
            +------------+          +------------+          +------------+

            +------------+          +------------+          +------------+
            |            |          |            |          |            |
==(Radio)==>|   cc2500   |--(SPI)-->|   ESP32    |--(BLE)-->| Smartphone |
            |            |          |            |          |            |
            +------------+          +------------+          +------------+
```
...
# Configuration
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/2385a5b4-4ee5-4370-bc44-453f53bd6a5c" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/cde77bfa-5e86-4f60-8a37-13b1b26ad74b" />
...
<img width="659" height="486" alt="Image" src="https://github.com/user-attachments/assets/0db25234-0155-4056-9384-76e2b01700ef" />
